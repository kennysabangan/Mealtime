  ...
  const getMeals = async () => {
    try {
      ...
      if (query) {
        ...
        let dietQuery = [], intolerancesQuery = [];
        tags.map(tag => {
          switch(tag) {
            case "dairy free":
          ...
          const intolerancesString = intolerancesQuery.length != 0 ? intolerancesQuery.join(',') : ' ';
    ...
    <div className="container">
      ...
      <div className="row">
        ...
        <div className="col-md-4">
          <div className="card">
            ...
            <div className="card-body text-center">
              ...
              <p className="card-text">
                Ready in: {meals && meal.readyInMinutes}{" "}
                minutes
              </p>
            </div>
          </div>
        ...
        >
          <button
            className={`meal-btn d-flex gap-3 align-items-center justify-content-center pt-3 ${
              meals && index == meals.recipes.length - 1
                ? "disabled"
                : null
            }`}
          >
